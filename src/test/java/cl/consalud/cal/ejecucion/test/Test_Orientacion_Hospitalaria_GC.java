...
//Desde la Linea de código 40 hasta la 49, código para ejecutar con herramienta Eclipse o vía Consola. 
@BeforeMethod
...
//Desde la Linea de código 52 hasta la 67, código para ejecutar con herramienta Jenkins 
public void configSelenium() {
		// Selenium config
		DesiredCapabilities caps = new DesiredCapabilities();
